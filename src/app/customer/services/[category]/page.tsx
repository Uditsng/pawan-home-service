              ...
              <article key={service.id} className="group bg-surface-container-lowest rounded-xl md:rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row border border-outline-variant/10">
                ...
                <div className="flex-1 p-4 md:p-6 flex flex-col justify-between">
                  ...
                  <div className="flex gap-2 md:gap-3">
                    <Link href={`/customer/services/${categorySlug}/${service.id}`} className="flex-1 text-center py-2.5 md:py-3 text-xs md:text-sm font-semibold text-primary border border-primary/20 rounded-lg hover:bg-primary/5 transition-colors">
                      View Details
                    </Link>
