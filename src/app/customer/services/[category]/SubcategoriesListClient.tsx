          ...
          {filteredSubcategories.map((sub) => {
            return (
              ...
              >
                ...
                <div className="w-14 h-14 md:w-18 md:h-18 rounded-xl md:rounded-2xl bg-green-500/10 mb-2 md:mb-4 flex items-center justify-center text-[#059669] transition-transform active:scale-105 overflow-hidden">
                  <ServiceVisual
