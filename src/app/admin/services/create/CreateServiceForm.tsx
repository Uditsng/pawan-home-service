    ...
    <form action={formAction} className="space-y-6 bg-surface-container-lowest p-5 sm:p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-outline-variant/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <select name="subcategory_id" required className="grow border border-outline-variant/20 rounded-lg p-3 bg-surface-container focus:ring-2 focus:ring-primary/20 outline-none transition-all" onChange={handleSubcategoryChange}>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input name="price_breakdown" type="text" className="w-full border border-outline-variant/20 rounded-lg p-3 bg-surface-container focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="e.g. Rupee 200 for each piece or seat" />
          </div>
        </div>
      ...
      <div>
        ...
        <div>
          ...
          <textarea name="description" required rows={4} className="w-full border border-outline-variant/20 rounded-lg p-3 bg-surface-container focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Detailed description for the service landing page..."></textarea>
        </div>
      </div>
