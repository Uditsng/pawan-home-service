...
export default function Footer() {
  return (
    <footer className="w-full bg-surface-container-lowest/40 border-t border-outline-variant/10 mt-auto">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-5 md:py-8">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between md:gap-4">
          ...
          <div className="flex items-center gap-3 justify-center md:justify-start">
            <Image
              ...
              height={40}
            />
            <span className="text-primary text-lg md:text-xl font-bold tracking-tighter whitespace-nowrap">
              PHS Cleaning Company
            </span>
          </div>

          {/* Navigation Links */}
          <ul className="flex flex-wrap justify-center items-center gap-x-5 gap-y-2 text-xs md:text-sm font-semibold text-on-surface-variant">
            <li>
        ...
        {/* Copyright */}
        <div className="flex flex-col items-center gap-2 md:flex-row md:justify-between text-xs md:text-sm text-on-surface-variant/80">
