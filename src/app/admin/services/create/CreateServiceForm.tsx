        ...
        <div className="flex border-b border-outline-variant/30 gap-1 overflow-x-auto no-scrollbar">
          {([
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-5 py-3 border-b-2 text-xs font-bold transition-all whitespace-nowrap cursor-pointer ${activeTab === tab.id
                      ...
                      {[30, 60, 90, 120, 180].map((mins) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-3.5 py-2 rounded-xl border text-[10px] font-bold transition-all ${isSelected
