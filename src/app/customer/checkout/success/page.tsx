    ...
    <div className="bg-background text-on-background font-body min-h-screen flex flex-col relative">
      ...
      <main className="grow flex flex-col items-center justify-center px-4 md:px-6 py-8 md:py-12 max-w-2xl mx-auto w-full z-10">
        ...
        <div className="w-full mt-10 md:mt-12 space-y-3 md:space-y-4 max-w-md mx-auto">
          <Link href="/customer/dashboard" className="w-full text-center block py-4 bg-primary text-white font-headline font-extrabold rounded-2xl shadow-lg hover:opacity-90 active:scale-[0.98] transition-all text-sm md:text-base border-none">
            Back to Home
          </Link>
          <Link href="/customer/bookings" className="w-full text-center block py-3 bg-transparent text-primary font-headline font-bold rounded-2xl hover:bg-surface-container-low transition-colors active:scale-[0.98] text-sm md:text-base">
            View My Bookings
          </Link>
        </div>
