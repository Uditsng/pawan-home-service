...
export default function PartnerErrorBoundary({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("Partner route error encountered:", error);
  }, [error]);
      ...
      <div className="w-full max-w-md glass-panel rounded-3xl p-8 text-center space-y-6 shadow-[rgba(30,41,59,0.06)_0px_20px_40px]">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-on-surface-variant leading-relaxed">
            An unexpected error occurred in your partner portal. Please try again or return to your dashboard.
          </p>
        </div>
