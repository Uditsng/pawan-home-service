    ...
    <div className="bg-surface font-body text-on-surface antialiased min-h-screen pb-24">
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <section className="mb-6">
          ...
          <div className="w-48 h-7 bg-surface-container-high rounded animate-pulse" />
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            {/* Step indicator */}
            <div className="bg-surface-container-lowest border border-outline-variant/10 rounded-2xl p-4 animate-pulse flex justify-between">
